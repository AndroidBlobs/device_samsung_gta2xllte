...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_old.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_old.xml \
...
# Inherit vendor
$(call inherit-product, vendor/samsung/gta2xllte/gta2xllte-vendor.mk)